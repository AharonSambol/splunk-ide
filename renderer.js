...
const { decodeSearchText, extractQueryFromUrl, getSearchText, parseSavedSearchFromUrl, parseDashboardFromUrl, shouldClearTabObjectOnNavigate, splunkUiUrlToRestBase, DEFAULT_SPLUNK_URL, withSplunkOrigin } = require('./lib/url-utils');
